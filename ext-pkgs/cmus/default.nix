...
let
  ...
  opts = [
    ...
    #(mkFlag mprisSupport   "CONFIG_MPRIS=y"   mpris)
...
stdenv.mkDerivation rec {
  ...
  src = fetchFromGitHub {
    owner =  "cmus";
    repo =  "cmus";
    rev =  "17bf542c6b120d9dcf6642b259d78badfc1143eb";
    sha256 =  "0gyd9dis7maqxqmawzfj1izh6r921himddai9m556ya2rfmsz01c";
  };
